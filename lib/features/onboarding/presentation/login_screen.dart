            ...
            children: [
              ...
              Hero(
                ...
                child: ColorFiltered(
                  ...
                  child: Image.asset('assets/logo/logo_t.png', width: 150, height: 150),
                ),
              ),
              ...
              Text(
                ...
                style: TextStyle(fontSize: 15, height: 1.55, color: Colors.white.withAlpha(163)),
              ),
              const Spacer(),
              if (Platform.isIOS) ...[
                LoginSocialBtn(
              ...
              Text(
                ...
                style: TextStyle(fontSize: 12.5, color: Colors.white.withAlpha(163), height: 1.5),
              ),
